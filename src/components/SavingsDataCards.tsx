...
const SavingsDataCards: React.FC = () => {
  ...
  return <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {savingsData.map(item => <div key={item.id} className="transparent-container bg-transparent p-6 flex flex-col items-center justify-center text-center min-h-[150px] border border-black">
            <p className="font-bold text-lg mb-2 text-zinc-800">{item.amount}</p>
