...
const Section5: React.FC = () => {
  ...
  return (
    <section id="section5" className="section bg-gradient-to-b from-white to-accent-50">
      <div className="section-content">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-transparent border border-black p-6 rounded-lg shadow-md card-hover">
            <h2 className="text-2xl font-bold mb-4 text-text-primary">{t('section5.competitors.title')}</h2>
            <p className="text-text-primary mb-2">{t('section5.competitors.fragmented')}</p>
            <ul className="mb-4 space-y-1 list-disc list-inside text-text-primary">
              <li>{t('section5.competitors.comp1')}</li>
              <li>{t('section5.competitors.comp2')}</li>
              <li>{t('section5.competitors.comp3')}</li>
            </ul>
            <p className="text-text-primary mb-2 font-medium">{t('section5.competitors.different')}</p>
          ...
          <div className="bg-transparent border border-black p-6 rounded-lg shadow-md card-hover">
            <h2 className="text-2xl font-bold mb-4 text-text-primary">{t('section5.status.title')}</h2>
            <p className="text-text-primary mb-2">{t('section5.status.current')}</p>
            <p className="text-text-primary mb-4">
              {t('section5.status.progress1')}<br />
              {t('section5.status.progress2')}<br />
              {t('section5.status.progress3')}
            </p>
            <p className="text-text-primary mb-2 font-medium">{t('section5.status.next')}</p>
